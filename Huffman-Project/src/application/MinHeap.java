...
public class MinHeap {
	...
	MinHeap(int maxNum) throws IOException {
		setup(maxNum);
	...
	private void setup(int maxNum) throws IOException {
		...
		if (maxNum > 0) {
			maxNumber = 0;
			elements = new HuffmanNode[maxNum + 1];
			HuffmanNode minimum = new HuffmanNode();
	...
	public void insertMinHeap(HuffmanNode data) {
